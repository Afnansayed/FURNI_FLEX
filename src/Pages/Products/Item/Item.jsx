    ...
    return (
        <>
            <section className='bg-base-100 w-full  lg:w-72 mx-auto p-6 shadow-2xl mb-2 text-sm '>
                     ...
                     <h1 onClick={handleAddToCart} className='bg-[#000000] text-white p-2 rounded-lg flex items-center justify-center'><span className='inline-block mr-2'><FaCartArrowDown/></span> Add to cart</h1>
            </section>
        </>
    );
};
